...
data class KakaoPayOrder (
        ...
        var selected_card_info : SelectedCardInfo?=null,//결제 카드 정보
        var payment_action_details : MutableList<PaymentActionDetails>?=null // 결제/취소 상세
)