<template>
    <div>
        ...
        <tr><td>스케줄명</td><td><input class="input1" type="text" /></td></tr>
        <tr><td>가격</td><td><input class="input1" type="number" /></td></tr>
        <tr><td>시작일</td><td><input class="input1" type="date" /></td></tr>
